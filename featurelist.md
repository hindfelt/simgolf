...
- Club selection: Driver/Iron/Wedge, scales distance + aim accuracy.
- Shot-shape techniques: Straight/Fade/Draw/High Backspin/Low Punch — fade/draw genuinely curve flight (shared curve math between the fired shot and the live aim-preview line), backspin skips roll-out entirely, punch never deflects off trees and flies flatter.
- Per-hole randomized wind, pushes flight shots only (not putts, not AI), aim-preview mirrors the exact wind/club/shape math including a dashed roll-out segment.
