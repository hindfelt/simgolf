...
export function packedMiddleWorldRecords(q){
 ...
 return {actors,facilityRecords,objectPrefixRecord,
...
export function packedMiddleMap(q){return {...middleMap(q),...originalPlannerWorldRecords(packedMiddleWorldRecords(q))};}
