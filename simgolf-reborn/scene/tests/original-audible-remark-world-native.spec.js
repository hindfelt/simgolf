...
import {originalAudibleRemarkWorld} from '../src/simulation/original-audible-remark-world.js';
...
test('automatic packed-world remark adapter matches native actor, counters and final message state',()=>{
 for(const [q,expected] of rows){
  ...
  const result=originalAudibleRemarkWorld({...q,state:world},{
   resolvePhrase:(e,s)=>{
