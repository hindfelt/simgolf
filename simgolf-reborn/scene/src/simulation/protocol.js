...
export const RULESET_VERSION = "regional-links-scrub-2026-09-12";
...
const golfVersions = new Map([[RULESET_VERSION,PROTOCOL_VERSION],[PRE_LINKS_RULESET,83],[PRE_VISIBLE_TREES_RULESET,82],[PRE_REGIONAL_TREES_RULESET,81],[PRE_AIRCRAFT_RULESET,80],
...
export const compatibleGolfRuleset = (value, environment=null, landscape=null) => {
  ...
  return version!==undefined && (environment!=='links' || version>=84) && (landscape!=='coast' || version>=83) && (environment!=='desert' || version>=82);
};
