...
export function originalShotMap({terrain,marks,derived,readHeight,metadata,globalFlags}) {
 ...
 return {terrainAt,kindAt:p=>terrainAt(p).kind,shotClassAt:code=>metadata(code).shotClass,
