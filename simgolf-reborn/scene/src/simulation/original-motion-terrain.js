...
export function createOriginalMotionTerrain({readCell,readCornerHeight,readVertexHeight,globalFlags,readNeighborTerrain}) {
 ...
 return {cellAt,neighborTerrainAt:readNeighborTerrain??((x,z)=>cellAt(x,z).code),heightAt:(x,z)=>originalPhysicsHeight(sample(x,z)),
