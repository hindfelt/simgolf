import {originalProjectionTable} from './original-projection-table.js';
const int32 = n => Number.isInteger(n) && n >= -0x80000000 && n <= 0x7fffffff;
// Shared table generated by executing the original x87 initializer.
export const ORIGINAL_SINE_TABLE = originalProjectionTable;
