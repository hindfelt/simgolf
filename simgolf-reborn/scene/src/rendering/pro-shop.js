...
export function proShop(scene,x,z,environment=null){
 ...
 const wall=tropical?0xb68b52:links?0xb7b3a1:desert?0xd0a56e:0xe3d5b1,trim=tropical?0x62452c:0x486050,roofColor=tropical?0xcdb272:links?0x59686a:desert?0xe1bd87:0x78573a;
 ...
 const roof=desert?adobeRoof(4.3,4.1):new THREE.CylinderGeometry(0,3.2,1.25,4);if(!desert)roof.rotateY(Math.PI/4);add(roof,roofColor,0,desert?2.85:3.3,-.25);
 for(let n=0;n<(desert?0:5);n++){const f=(n+.5)/5;for(const side of [-1,1])box(4.5*(1-f),.025,.05,tropical?0xb99a60:0x667264,0,2.68+f*1.25,-.25+side*2.25*(1-f));}
