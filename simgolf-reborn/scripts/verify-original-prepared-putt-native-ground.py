...
for q,e in rows:
 ...
 assert motion_done
 q['capturedTarget']=motion_done and v.reg_read(UC_X86_REG_EIP)==0x42c3f4 and [vr(0x102018),vr(0x102020)]==[q['cup']['x'],q['cup']['z']]
...
console.log('36 native planned putts with original ground coefficients match through rolling termination.');
