"""Verify route search with real range and follow-up assessment arithmetic."""
...
if '--write-fixture' in __import__('sys').argv:
 ...
 (root/'simgolf-reborn/scene/tests/fixtures/original-assessed-route-search.json').write_text(json.dumps(fixtures,separators=(',',':'))+'\n')
