...
def run(q):
 ...
 for off,v in [(0x34,0),(0x1c,q['sampleScore']),(0xbc,q['score']),(0x38,q['samples']),(0x28,q['goodLandings']),(0x60,w['score']),(0x18,q['target']['z']),(0x2c,q['target']['x']),(0x10,q['cornerTarget']),(0x14,q['curve']),(0x536c,q['sampleFlags']),(0x78,w['target']['x']),(0xa4,w['target']['z']),(0x6c,w['curve']),(0xac,w['landingFlag'])]:write(sp+off,v)
