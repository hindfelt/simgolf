...
for i in range(800):
 ...
 calls=[];samples=0;mutate=i%2==0;u.reg_write(UC_X86_REG_ESP,0x102000);u.reg_write(UC_X86_REG_EBP,0);u.reg_write(UC_X86_REG_EBX,6);u.reg_write(UC_X86_REG_EDI,code);u.reg_write(UC_X86_REG_EAX,25000);u.reg_write(UC_X86_REG_ECX,25000);u.emu_start(0x42c13a,0x400fff,count=100000)
