...
for i in range(500):
 ...
 q.update(cashUnits=1000,ledgerPeriod=0,type6Level=1,type8Level=1,type10Level=1);put(0x570a24,1000);put(0x5a5784,0);put(0x582c64,0);put(0x5a7698,1);put(0x5a76a0,1);put(0x5a76a8,1);u.mem_write(0x577254,bytes(2500));u.mem_write(0x5682dc,bytes(2500))
