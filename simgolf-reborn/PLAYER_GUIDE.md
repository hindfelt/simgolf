...
- **Transport visitors:** connected helipads, marinas and airstrips attract additional pairs beyond the walk-in visitor pool. They need an open, reachable hole and room for a pair. Helicopters still charge $200 per landing, with at most one present. Airstrips deliver occasional airport transfers; these do not yet animate a plane landing.
- **Marinas:** keep a clear water channel beyond the central berth. A visiting boat arrives, moors while its passengers play and use facilities, then leaves after both return. Two other boats stay moored. Inspect for passenger status or blocked water. Repair water/path access if a boat or visitor is stranded. An occupied marina cannot be removed.
- **Extra practice:** some golfers choose a 24-second driving-range or putting-green visit after their round. Golfing partners can also play tennis. These visits count as facility use, without adding a golf round or inventing a fee.
